...
import { useNavigation } from '@react-navigation/native';
    ...
    const CardInformationOfMovie = (props) => {
                ...
                <View style = {styles.container}> 
                    ...
                    <Text style={styles.title}>{props.Title}</Text>             
                        ...
                        <View style = {styles.Add}>
                            <TouchableOpacity key = {props.ID} onPress={onAddAndDeleteListInMovie} style={styles.buttonMovie}>
                                <Text key = {props.ID} style={styles.btnAdd}>{valid ? <Ionicons name="add-circle-outline" size={20} color="white" />  : <AntDesign name="check" size={24} color="white" /> }</Text>
    ...
    export default CardInformationOfMovie